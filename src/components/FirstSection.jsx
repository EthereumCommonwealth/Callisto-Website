...
import backgroundMP4 from '../images/Hello-World.mp4'
import backgroundWEBM from '../images/Hello-World.webm'
                ...
                <div className="FirstSection-content container">
                  <div>
                    ...
                    <div className="FirstSection-btns">
                      ...
                      <a
                        className="FirstSection-btns-blue"
                        href="https://clostats.net/"
                        target="_blank"
                      >
                        Callisto Stats
                      </a>
